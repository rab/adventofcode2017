...
# blocks. The goal of the reallocation routine is to balance the blocks between the memory banks.
#
...
begin
  ...
  cycles += 1
  # puts "#{cycles}: #{banks}"
end until configurations.include? banks
...
puts "Part2:", cycles - configurations.index(banks)
